...
- A `PDF <../latex/lignum.pdf>`_ version of |lignum| documentation is 
  available.

.. seealso::

   More documentation can be found on the
   `openalea <http://openalea.gforge.inria.fr/dokuwiki/doku.php?id=packages:alinea:lignum:lignum>`__ wiki.
